...
function SW_1Click_Zoom_Out:Name() return "1Click Zoom Out" end

function SW_1Click_Zoom_Out:Version() return "1.00" end

function SW_1Click_Zoom_Out:Description() return "1Click Zoom Out" end

function SW_1Click_Zoom_Out:Creator() return "howdy(sootwork)" end

function SW_1Click_Zoom_Out:UILabel() return "1Click Zoom Out" end

-- **************************************************
-- Recurring values
-- **************************************************

SW_1Click_Zoom_Out.scaleAry = {
...
function SW_1Click_Zoom_Out:Run(moho)
...
function SW_1Click_Zoom_Out:GetNearestValue(list, v)
    local i
    local num
    local minv
